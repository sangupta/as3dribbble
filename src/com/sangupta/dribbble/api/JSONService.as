...
package com.sangupta.dribbble.api {
	...
	/**
	 * Utility class to invoke a given URL and return the result as a JSON
	 * object and call the appropriate completion/error handlers.
	 * 
	 * @author sangupta
	 */
	public class JSONService {
		...
		protected function massageStreamData(streamData:String):* {
			...
			returnObject = JSON.parse(streamData);
			return returnObject;
		}
